...
export default function ThemeSwitcher({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <div className="relative">
      ...
      >
        <Palette className={compact ? "h-4 w-4" : "h-[18px] w-[18px] flex-shrink-0"} />
      ...
      {isOpen && (
        <>
          ...
          {/* Panel */}
          <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[90vw] max-w-md animate-scale-in">
            <div
