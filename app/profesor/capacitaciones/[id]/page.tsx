    ...
    <div>
      ...
      <div className="p-4 lg:p-6 space-y-5 lg:space-y-6">
        ...
        <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-[12.5px] text-[#a5a9b8]">
          <Link href="/profesor/capacitaciones" className="hover:text-[#15182b] transition-colors">
            Capacitaciones
          </Link>
        ...
        >
          ...
          <div aria-hidden="true" className="pointer-events-none absolute right-[100px] bottom-[-50px] w-[120px] h-[120px] rounded-full"
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 ml-12 sm:ml-0">
                        ...
                        <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-[700] ${
                          isDone ? "bg-[#dbeee3] text-[#1a6a43]" : "bg-[#fff8e8] text-[#9a6800]"
                        }`}>
                          <span className="h-1.5 w-1.5 rounded-full bg-current opacity-70" />
