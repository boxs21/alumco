                ...
                <Table>
                  ...
                  <TableBody>
                    {assignments.map((a) => {
                      ...
                      return (
                        <TableRow key={a.id}>
                          <TableCell className="text-sm font-medium text-[#1e2d1c]">{title}</TableCell>
                          <TableCell>
                            <Badge
                              className={
                                a.status === "COMPLETED"
                        ...
                        <TableRow key={c.id}>
                          ...
                          <TableCell className="text-right">
                            {c.pdf_url ? (
                              ...
                              <button disabled className="inline-flex items-center gap-2 h-9 px-4 rounded-lg border border-[#dde0d4] bg-[#faf9f6] text-sm font-medium text-[#a4ac86] opacity-50 cursor-not-allowed">
                                <Download className="h-4 w-4" />
                                <span className="hidden sm:inline">Descargar</span>
                              </button>
                            )}
