    ...
    <div>
      ...
      <div className="p-4 lg:p-6 space-y-4">
        ...
        <div className="rounded-2xl border border-[#e8e4dc] bg-[#f6f3ee] overflow-hidden">
          {/* Header */}
          <div className="grid grid-cols-4 gap-4 px-5 py-3 border-b border-[#e8e4dc] bg-[#eaf0fb]">
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="grid grid-cols-4 gap-4 px-5 py-4 border-b border-[#e8e4dc] last:border-0">
