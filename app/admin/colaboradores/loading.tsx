  ...
  return (
    <div>
      ...
      <div className="p-4 lg:p-6 space-y-4">
        ...
        {/* Table skeleton */}
        <div className="rounded-2xl border border-[#dde0d4] bg-[#faf9f6] overflow-hidden">
          {/* Header */}
          <div className="grid grid-cols-4 gap-4 px-5 py-3 border-b border-[#dde0d4] bg-[#f0f2eb]">
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="grid grid-cols-4 gap-4 px-5 py-4 border-b border-[#dde0d4] last:border-0">
